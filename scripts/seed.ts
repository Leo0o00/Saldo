...
// You can extract this ID from your dashboard in Clerk. Copy the ID of your logged-in user in your application.
const SEED_USER_ID = process.env.SEED_USER_ID!; // Assuming a single user for seeding
