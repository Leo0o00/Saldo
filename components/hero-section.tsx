              ...
              <div className="md:w-1/2">
                <div>
                  <h1 className="max-w-md text-balance text-5xl font-medium md:text-6xl">
                    Simple finance app for everyone
                  </h1>
                  <p className="text-muted-foreground my-8 max-w-2xl text-balance text-xl">
                    A tool that allows you to manage your finances in a simple
                    and intuitive way and even import your records from a CSV
